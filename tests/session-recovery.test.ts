...
const settings = { imageId: "custom", localFormat: "cdrom" as const, memoryMiB: 4096 as const, displayId: "uhd-4k" as const, acpiExperimental: true, retainLocalMedium: true };

      ...
      <section class="control-grid" aria-label="لوحة إطلاق البيئة المحلية">
        ...
        <section class="workspace">
          ...
          <div class="workspace-actions">
            ...
            <label class="memory-field"><input id="acpi-toggle" type="checkbox" ${enableAcpiExperimental ? "checked" : ""} ${isRunning ? "disabled" : ""}> ACPI لمسار Windows<small>يضيف جداول firmware اللازمة لمسار Windows Boot Manager في جلسة v86 المحلية.</small></label>

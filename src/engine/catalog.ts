...
export const LOCAL_IMAGES: readonly LocalImageDescriptor[] = [
  ...
  {
    id: "kolibrios-candidate",
    label: "KolibriOS — x86 مفتوح المصدر",
    family: "kolibrios",
    format: "cdrom",
    source: "open-source-catalog",
    terms: "KolibriOS مرشح GPLv2. لا تُرفق صورة قبل تثبيت الإصدار ومصدره وإشعاراته في الكتالوج.",
    supportLevel: "not-bundled",
  },
  {
    id: "alpine-candidate",
    label: "Alpine Linux — بيئة خفيفة",
    family: "alpine",
    format: "cdrom",
    source: "open-source-catalog",
    terms: "Alpine مرشح خفيف؛ تعتمد التراخيص على الحزم ولا تُرفق صورة قبل تدقيق إصدارها ومصدرها.",
    supportLevel: "not-bundled",
  },
  {
